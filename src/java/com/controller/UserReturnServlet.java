...
public class UserReturnServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        String borrowRequestIdStr = request.getParameter("borrowRequestId");
        ...
        try (Connection conn = DBConnection.getConnection()) {
            // Get expiry date and book id for this borrow request
            PreparedStatement ps1 = conn.prepareStatement(
                "SELECT expiry_date, book_id FROM borrow_requests WHERE id = ?");
            ...
            if (rs.next()) {
                ...
                if (expiryDate != null && returnDate.after(expiryDate)) {
                    ...
                    fine = daysLate * 10; // 10 units fine per day
                }

                // Update borrow_requests to returned
                ...
                if (updated > 0) {
                    ...
                    session.setAttribute("errorMessage", "Failed to return the book.");
                }
        ...
        response.sendRedirect("user/userBorrowHistory.jsp");
    }
}
